...
@Component({
  ...
  templateUrl: './admin-update-users.component.html',
  styleUrl: './admin-update-users.component.css'
})
export class AdminUpdateUsersComponent implements OnInit {
